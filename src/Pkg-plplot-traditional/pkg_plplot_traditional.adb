...
package body pkg_plplot_traditional is
...
--------- Simple Contour Plotter ------
    ...
    begin
        ...
        plcol0(White);
        PKG_PLPLOT_TRADITIONAL.plbox("bcnst", 0.0, 0, "bcnstv", 0.0, 0); -- I have no idea why the compiler requires PKG_PLPLOT_TRADITIONAL. here.
        plcol0(White);
        pllab(X_Label, Y_Label, Title_Label);
        plcol0(White);
        pl_setcontlabelparam(0.008, 0.6, 0.1, True);
        plcont(z, z'First(1), z'Last(1), z'First(2), z'Last(2),
            Contour_Levels, PKG_PLPLOT_THIN.pltr0'access, System.Null_Address);
    end Simple_Contour;
...
-- These correspond to the section in plot.h called "Function Prototypes".
    ...
    begin
        PKG_PLPLOT_THIN.pl_setcontlabelformat(Limit_Exponent, Significant_Digits);
    ...
    begin
        ...
        PKG_PLPLOT_THIN.pl_setcontlabelparam(Label_Offset, Label_Font_Height, Label_Spacing, active);
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plarc(x, y, a, b, angle1, angle2, rotate, fill_arc);
    end plarc;
    ...
    begin
        PKG_PLPLOT_THIN.plvect(Matrix_To_Pointers(u), Matrix_To_Pointers(v), u'Length(1), u'Length(2),
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plsvect(X_Vertices, Y_Vertices, X_Vertices'length, fill);
    end plsvect;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plsvectdefault(X_Vertices, Y_Vertices, 0, fill);
    end plsvect;
    ...
    begin
        PKG_PLPLOT_THIN.plsvectdefault(System.Null_Address, System.Null_Address, 0, PLfalse);
    end plsvect;
    ...
    begin
        PKG_PLPLOT_THIN.plbin(Bin_Values'length, Bin_Values, Bin_Counts, Options);
    end plbin;
    ...
    procedure plbtime
       (year, month, day, hour, min : out Integer;
        ...
        ctime                       : Long_Float) is
    begin
        PKG_PLPLOT_THIN.plbtime(year, month, day, hour, min, sec, ctime);
    end plbtime;
    ...
    begin
        PKG_PLPLOT_THIN.plcalc_world(x_Relative, y_Relative, x_World, y_World, Last_Window_Index);
    end plcalc_world;
    ...
    begin
        PKG_PLPLOT_THIN.plcol0(A_Color);
    end plcol0;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plconfigtime(skale, offset1, offset2, ccontrol,
    ...
    procedure plcont
       (z                                : Real_Matrix;
        ...
        Transformation_Data_Pointer      : PL_Pointer) is
    begin
        PKG_PLPLOT_THIN.plcont(Matrix_To_Pointers(z), z'Length(1), z'Length(2),
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plfcont(Function_Evaluator_Pointer, Irregular_Data_Address,
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plcpstrm(Stream_ID, PL_Do_Not_Copy_Device_Coordinates);
    end plcpstrm;
    ...
    begin
        PKG_PLPLOT_THIN.plctime(year, month, day, hour, min, sec, ctime);
    end plctime;
    ...
    begin
        PKG_PLPLOT_THIN.plenv(x_Min, x_Max, y_Min, y_Max, Justification, Axis_Style);
    end plenv;
    ...
    procedure plenv0
       (x_Min, x_Max, y_Min, y_Max : Long_Float;
        ...
        Axis_Style                 : Axis_Style_Type) is
    begin
        PKG_PLPLOT_THIN.plenv0(x_Min, x_Max, y_Min, y_Max, Justification, Axis_Style);
    end plenv0;
    ...
    begin
        PKG_PLPLOT_THIN.plerrx(x_Min'Length, x_Min, x_Max, y);
    end plerrx;
    ...
    begin
        PKG_PLPLOT_THIN.plerry(y_Min'Length, x, y_Min, y_Max);
    end plerry;
    ...
    begin
        PKG_PLPLOT_THIN.plfill(x'Length, x, y);
    end plfill;
    ...
    begin
        PKG_PLPLOT_THIN.plfill3(x'Length, x, y, z);
    end plfill3;
    ...
    begin
        PKG_PLPLOT_THIN.plfont(Font_Style);
    end plfont;
    ...
    begin
        PKG_PLPLOT_THIN.plfontld(Character_Set);
    end plfontld;
    ...
    begin
        PKG_PLPLOT_THIN.plgchr(Default_Height, Current_Height);
    end plgchr;
    ...
    begin
        PKG_PLPLOT_THIN.plgcol0(Color_Index, Red_Component, Green_Component, Blue_Component);
    end plgcol0;
    ...
    begin
        PKG_PLPLOT_THIN.plgcol0a(Color_Index, Red_Component, Green_Component, Blue_Component, Alpha);
    end plgcol0a;
    ...
    procedure plgcolbg
       (Red_Component, Green_Component, Blue_Component : out Integer) is
    begin
        PKG_PLPLOT_THIN.plgcolbg(Red_Component, Green_Component, Blue_Component);
    end plgcolbg;
    ...
    procedure plgcolbga
       (Red_Component, Green_Component, Blue_Component : out Integer;
        Alpha                                          : out Long_Float_0_1_Type) is
    begin
        PKG_PLPLOT_THIN.plgcolbga(Red_Component, Green_Component, Blue_Component,
            Alpha);
    end;
    ...
    begin
        PKG_PLPLOT_THIN.plgcompression(Compression_Level);
    end plgcompression;
    ...
    begin
        PKG_PLPLOT_THIN.plgdev(PL_Device_Name);
    ...
    begin
        PKG_PLPLOT_THIN.plgdidev(Relative_Margin_Width, Aspect_Ratio, x_Justification, y_Justification);
    end plgdidev;
    ...
    begin
        PKG_PLPLOT_THIN.plgdiori(Rotation);
    end plgdiori;
    ...
    begin
        PKG_PLPLOT_THIN.plgdiplt(x_Min, y_Min, x_Max, y_Max);
    end plgdiplt;
    ...
    begin
        PKG_PLPLOT_THIN.plgfci(Font_Characterization_Integer);
    end plgfci;
    ...
    begin
        PKG_PLPLOT_THIN.plgfont(Family, Style, Weight);
    end;
    ...
    begin
        PKG_PLPLOT_THIN.plgfam(PL_Family_Enabled, Family_File_Number, Maximum_File_Size);
    ...
    begin
        PKG_PLPLOT_THIN.plgfnam(PL_Output_File_Name);
    ...
    begin
        PKG_PLPLOT_THIN.plglevel(Run_Level);
    end plglevel;
    ...
    begin
        PKG_PLPLOT_THIN.plgpage(x_Pixels, y_Pixels, x_Page_Length, y_Page_Length, x_Page_Offset, y_Page_Offset);
    end plgpage;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plgriddata(x, y, z, x'Length, x_Grid, x_Grid'Length, y_Grid, y_Grid'Length,
    ...
    begin
        PKG_PLPLOT_THIN.plgspa(Left_Edge, Right_Edge, Bottom_Edge, Top_Edge);
    end plgspa;
    ...
    begin
        PKG_PLPLOT_THIN.plgstrm(Stream_Number);
    end plgstrm;
    ...
    begin
        PKG_PLPLOT_THIN.plgver(PL_Version_Number);
    ...
    begin
        PKG_PLPLOT_THIN.plgvpd(x_Min, x_Max, y_Min, y_Max);
    end plgvpd;
    ...
    begin
        PKG_PLPLOT_THIN.plgvpw(x_Min, x_Max, y_Min, y_Max);
    end plgvpw;
    ...
    begin
        PKG_PLPLOT_THIN.plgxax(Max_Digits, Actual_Digits);
    end plgxax;
    ...
    begin
        PKG_PLPLOT_THIN.plgyax(Max_Digits, Actual_Digits);
    end plgyax;
    ...
    begin
        PKG_PLPLOT_THIN.plgzax(Max_Digits, Actual_Digits);
    end plgzax;
    ...
    begin
        PKG_PLPLOT_THIN.plhlsrgb(Hue_Component, Lightness_Component, Saturation_Component, Red_Component, Green_Component, Blue_Component);
    end plhlsrgb;
    ...
    begin
        PKG_PLPLOT_THIN.pljoin(x1, y1, x2, y2);
    end pljoin;
    ...
    begin
        PKG_PLPLOT_THIN.pllab(To_C(X_Label, True), To_C(Y_Label, True), To_C(Title_Label, True));
    end pllab;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.pllegend(Legend_Width, Legend_Height, Options, Position,
    ...
    begin
        ...
        PL_Values := Matrix_To_Pointers(PKG_PLPLOT_THIN.PL_Transpose(Values));
        PKG_PLPLOT_THIN.plcolorbar(Colorbar_Width, Colorbar_Height, Options, Position, X_Offset,
    ...
    procedure pllightsource
       (x : Long_Float := 1.0;
        ...
        z: Long_Float := 1.0) is
    begin
        PKG_PLPLOT_THIN.pllightsource(x, y, z);
    end pllightsource;
    ...
    begin
        PKG_PLPLOT_THIN.plline(x'Length, x, y);
    end plline;
    ...
    begin
        PKG_PLPLOT_THIN.plline3(x'Length, x, y, z);
    end plline3;
    ...
    begin
        PKG_PLPLOT_THIN.pllsty(Line_Style);
    end pllsty;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plmap(Map_Form_Function_Pointer, To_C(To_String(Map_Kind_String), True),
    ...
    begin
        PKG_PLPLOT_THIN.plmapfill(Map_Form_Function_Pointer, To_C(Shapefile_File_Name),
    ...
    begin
        PKG_PLPLOT_THIN.plmapfill_Overload(Map_Form_Function_Pointer, To_C(Shapefile_File_Name),
    ...
    procedure plmapline
       (Map_Form_Function_Pointer  : Map_Form_Function_Pointer_Type;
        ...
        Plot_Entries               : Integer_Array_1D) is
    begin
        PKG_PLPLOT_THIN.plmapline(Map_Form_Function_Pointer, To_C(Shapefile_File_Name),
            Min_X, Max_X, Min_Y, Max_Y, Plot_Entries, Plot_Entries'Length);
    end plmapline;
    ...
    procedure plmapline
       (Map_Form_Function_Pointer  : Map_Form_Function_Pointer_Type;
        ...
        Plot_Entries               : PL_Pointer) is
    begin
        PKG_PLPLOT_THIN.plmapline_Overload(Map_Form_Function_Pointer, To_C(Shapefile_File_Name),
            Min_X, Max_X, Min_Y, Max_Y, Plot_Entries, 0);
    end plmapline;
    ...
    procedure plmapstring
       (Map_Form_Function_Pointer : Map_Form_Function_Pointer_Type;
        ...
        Plot_Entries : Integer_Array_1D) is
    begin
        PKG_PLPLOT_THIN.plmapstring(Map_Form_Function_Pointer, To_C(Shapefile_File_Name),
            Min_X, Max_X, Min_Y, Max_Y, Plot_Entries, Plot_Entries'Length);
    end plmapstring;
    ...
    begin
        Pkg_Plplot_Thin.plmaptex(Map_Form_Function_Pointer, To_C(Shapefile_File_Name), dx, dy,
    ...
    procedure plmeridians
       (Map_Form_Function_Pointer            : Map_Form_Function_Pointer_Type;
        ...
        Minimum_Latitude,  Maximum_Latitude  : Long_Float) is
    begin
        PKG_PLPLOT_THIN.plmeridians(Map_Form_Function_Pointer, Delta_Longitude, Delta_Latitude,
            Minimum_Longitude, Maximum_Longitude, Minimum_Latitude, Maximum_Latitude);
    end plmeridians;
    ...
    procedure plmesh
       (x, y    : Real_Vector; -- surface definition points
        ...
        Options : Integer) is
    begin
        PKG_PLPLOT_THIN.plmesh(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options);
    end plmesh;
    ...
    begin
        PKG_PLPLOT_THIN.plmeshc(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options, Contour_Levels, Contour_Levels'Length);
    end plmeshc;
    ...
    begin
        PKG_PLPLOT_THIN.plmkstrm(New_Stream_Number);
    end plmkstrm;
    ...
    procedure plmtex
       (Side : String;
        ...
        The_Text : String) is
    begin
        PKG_PLPLOT_THIN.plmtex(To_C(Side, True), Position_From_Edge, Position_Along_Edge, Justification, To_C(The_Text, True));
    end plmtex;
    ...
    procedure plmtex3
       (Side : String;
        ...
        The_Text : String) is
    begin
        PKG_PLPLOT_THIN.plmtex3(To_C(Side, True), Position_From_Edge, Position_Along_Edge, Justification, To_C(The_Text, True));
    end plmtex3;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plot3d(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options, PLsides);
    end plot3d;
    ...
    procedure plot3dc
       (x, y           : Real_Vector; -- surface definition points
        ...
        Contour_Levels : Real_Vector) is -- levels at which to draw contours
    begin
        PKG_PLPLOT_THIN.plot3dc(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options, Contour_Levels, Contour_Levels'Length);
    end plot3dc;
    ...
    begin
        PKG_PLPLOT_THIN.plot3dcl(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options, Contour_Levels, Contour_Levels'Length, ixstart, ixn, indexymin, indexymax);
    end plot3dcl;
    ...
    begin
        PKG_PLPLOT_THIN.plpat(Inclinations'Length, Inclinations, Spacings);
    end plpat;
    ...
    begin
        PKG_PLPLOT_THIN.plpath(Num_Segments, x1, y1, x2, y2);
    end plpath;
    ...
    begin
        PKG_PLPLOT_THIN.plpoin(x'Length, x, y, Symbol_As_Number);
    end plpoin;
    ...
    procedure plpoin3
       (x, y, z          : Real_Vector;
        Symbol_As_Number : Integer) is
    begin
        PKG_PLPLOT_THIN.plpoin3(x'Length, x, y, z, Symbol_As_Number);
    end plpoin3;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plpoly3(x'length, x, y, z, PL_Draw_Segments, PL_Draw_Counterclockwise);
    end plpoly3;
    ...
    begin
        if Set_Manually then
            PKG_PLPLOT_THIN.plprec(1, Number_Digits_After_Decimal_Point);
        else
            PKG_PLPLOT_THIN.plprec(0, Number_Digits_After_Decimal_Point);
        end if;
    end plprec;
    ...
    begin
        PKG_PLPLOT_THIN.plpsty(Fill_Pattern);
    end plpsty;
    ...
    procedure plptex
       (x, y             : Long_Float;
        ...
        The_Text         : String) is
    begin
        PKG_PLPLOT_THIN.plptex(x, y, Delta_X, Delta_Y, Justification, To_C(The_Text, True));
    end plptex;
    ...
    procedure plptex3
       (x, y, z                   : Long_Float;
        ...
        The_Text                  : String) is
    begin
        PKG_PLPLOT_THIN.plptex3(x, y, z, Delta_X, Delta_Y, Delta_Z, Shear_X, Shear_Y, Shear_Z,
    ...
    begin
        return PKG_PLPLOT_THIN.plrandd;
    end plrandd;
    ...
    begin
        PKG_PLPLOT_THIN.plrgbhls(Red_Component, Green_Component, Blue_Component, Hue_Component, Lightness_Component, Saturation_Component);
    end plrgbhls;
    ...
    begin
        PKG_PLPLOT_THIN.plschr(Default_Height, Scale_Factor);
    end plschr;
    ...
    begin
        PKG_PLPLOT_THIN.plscmap0(Red_Components, Green_Components, Blue_Components, Red_Components'Length);
    end plscmap0;
    ...
    begin
        PKG_PLPLOT_THIN.plscmap0a(Red_Components, Green_Components, Blue_Components, Alpha, Red_Components'Length);
    end plscmap0a;
    ...
    begin
        PKG_PLPLOT_THIN.plscmap0n(Number_Of_Colors);
    end plscmap0n;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plscmap1(PL_Red_Component, PL_Green_Component, PL_Blue_Component, PL_Red_Component'Length);
    end plscmap1;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plscmap1a(PL_Red_Component, PL_Green_Component, PL_Blue_Component, Alpha, PL_Red_Component'Length);
    end plscmap1a;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plscmap1l(PL_Color_Model, Control_Points'Length, Control_Points, H_Or_R, L_Or_G, S_Or_B, PL_Alt_Hue_Path);
    end plscmap1l;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plscmap1la(PL_Color_Model, Control_Points'Length, Control_Points, H_Or_R, L_Or_G, S_Or_B, Alpha, PL_Alt_Hue_Path);
    end plscmap1la;
    ...
    begin
        PKG_PLPLOT_THIN.plscmap1n(Number_Of_Colors);
    end plscmap1n;
    ...
    begin
        PKG_PLPLOT_THIN.plscmap1_range(Min_Color, Max_Color);
    end plscmap1_range;
    ...
    begin
        PKG_PLPLOT_THIN.plgcmap1_range(Min_Color, Max_Color);
    end plgcmap1_range;
    ...
    begin
        PKG_PLPLOT_THIN.plscol0(Plot_Color, Red_Component, Green_Component, Blue_Component);
    end plscol0;
    ...
    begin
        PKG_PLPLOT_THIN.plscol0a(Plot_Color, Red_Component, Green_Component, Blue_Component, Alpha);
    end plscol0a;
    ...
    procedure plscolbg
       (Red_Component, Green_Component, Blue_Component : Integer) is
    begin
        PKG_PLPLOT_THIN.plscolbg(Red_Component, Green_Component, Blue_Component);
    end plscolbg;
    ...
    procedure plscolbga
       (Red_Component, Green_Component, Blue_Component : Integer;
        Alpha                                          : Long_Float_0_1_Type) is
    begin
        PKG_PLPLOT_THIN.plscolbga(Red_Component, Green_Component, Blue_Component, Alpha);
    end plscolbga;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plscolor(PL_Enable_Color);
    end plscolor;
    ...
    begin
        PKG_PLPLOT_THIN.plscompression(Compression_Level);
    end plscompression;
    ...
    begin
        PKG_PLPLOT_THIN.plsdev(To_C(Device_Name, True));
    end plsdev;
    ...
    begin
        PKG_PLPLOT_THIN.plsdidev(Margin, Aspect_Ratio, x_Justification, y_Justification);
    end plsdidev;
    ...
    begin
        PKG_PLPLOT_THIN.plsdimap(dimxmin, dimxmax, dimymin, dimymax, dimxpmm, dimypmm);
    end plsdimap;
    ...
    begin
        PKG_PLPLOT_THIN.plsdiori(Rotation);
    end plsdiori;
    ...
    begin
        PKG_PLPLOT_THIN.plsdiplt(x_Min, y_Min, x_Max, y_Max);
    end plsdiplt;
    ...
    begin
        PKG_PLPLOT_THIN.plsdiplz(x_Min_Relative, y_Min_Relative, x_Max_Relative, y_Max_Relative);
    end plsdiplz;
    ...
    begin
        ...
        if Ada.Strings.Maps.Is_In(Escape_Character, Escape_Characters) then
            PKG_PLPLOT_THIN.plsesc(To_C(Escape_Character));
        else
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plsfam(PL_Enable_Family, Family_File_Number, Maximum_File_Size);
    end plsfam;
    ...
    begin
        PKG_PLPLOT_THIN.plsfci(Font_Characterization_Integer);
    end plsfci;
    ...
    begin
        PKG_PLPLOT_THIN.plsfont(Family, Style, Weight);
    end;
    ...
    begin
        PKG_PLPLOT_THIN.plsfnam(To_C(Output_File_Name, True));
    end plsfnam;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plshade(Matrix_To_Pointers(z), z'Length(1), z'Length(2), Mask_Function_Pointer,
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plshades(Matrix_To_Pointers(z), z'Length(1), z'Length(2), Mask_Function_Pointer,
    ...
    begin
        PKG_PLPLOT_THIN.plslabelfunc(Custom_Label_Procedure_Pointer, label_data);
    end plslabelfunc;
    ...
    begin
        PKG_PLPLOT_THIN.plsmaj(Default_Length, Scale_Factor);
    end plsmaj;
    ...
    begin
        PKG_PLPLOT_THIN.plsmem(x_Size, y_Size, Plot_This);
    end plsmem;
    ...
    begin
        PKG_PLPLOT_THIN.plsmin(Default_Length, Scale_Factor);
    end plsmin;
    ...
    begin
        if Orientation = Landscape then
            PKG_PLPLOT_THIN.plsori(0);
        else -- Orientation = Portrait
            PKG_PLPLOT_THIN.plsori(1);
        end if;
    end plsori;
    ...
    begin
        PKG_PLPLOT_THIN.plspage(x_Pixels, y_Pixels, x_Length, y_Length, x_Offset, y_Offset);
    end plspage;
    ...
    begin
        PKG_PLPLOT_THIN.plspal0(To_C(Color_File_Name, True));
    end plspal0;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plspal1(To_C(Color_File_Name, True), PL_Interpolate);
    end plspal1;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plspause(PL_Pause);
    end plspause;
    ...
    begin
        PKG_PLPLOT_THIN.plsstrm(Stream_Number);
    end plsstrm;
    ...
    begin
        PKG_PLPLOT_THIN.plssub(x_Number, y_Number);
    end plssub;
    ...
    begin
        PKG_PLPLOT_THIN.plssym(Default_Height, Scale_Factor);
    end plssym;
    ...
    begin
        PKG_PLPLOT_THIN.plstar(Number_Horizontal_Subpages, Number_Vertical_Subpages);
    end plstar;
    ...
    procedure plstart
       (Device_Name                                          : String;
        Number_Horizontal_Subpages, Number_Vertical_Subpages : Integer := 1) is
    begin
        PKG_PLPLOT_THIN.plstart(To_C(Device_Name), Number_Horizontal_Subpages, Number_Vertical_Subpages);
    end plstart;
    ...
    begin
        PKG_PLPLOT_THIN.plstransform(Coordinate_Transform_Procedure_Pointer,
    ...
    begin
        PKG_PLPLOT_THIN.plstransform(null, System.Null_Address);
    ...
    begin
        PKG_PLPLOT_THIN.plstring(x'Length, x, y, To_C(Plot_This_String));
    end plstring;
    ...
    procedure plstring3
       (x, y, z : Real_Vector;
        Plot_This_String : String) is
    begin
        PKG_PLPLOT_THIN.plstring3(x'Length, x, y, z, To_C(Plot_This_String));
    end plstring3;
    ...
    procedure plstripa
       (ID         : Integer;
        ...
        x, y       : Long_Float) is
    begin
        PKG_PLPLOT_THIN.plstripa(ID, Pen_Number, x, y);
    end plstripa;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plstripc(ID, To_C(X_Options), To_C(Y_Options),
    ...
    procedure plimagefr
       (Data                             : Real_Matrix;
        ...
        Transformation_Data_Pointer      : PL_Pointer) is
    begin
        PKG_PLPLOT_THIN.plimagefr(Matrix_To_Pointers(Data), Data'Length(1), Data'Length(2),
    ...
    begin
        PKG_PLPLOT_THIN.plimage(Matrix_To_Pointers(Data), Data'Length(1), Data'Length(2), x_Min, x_Max, y_Min, y_Max, z_Min, z_Max, Dxmin, Dxmax, Dymin, Dymax);
    end plimage;
    ...
    begin
        PKG_PLPLOT_THIN.plstyl(Marks'Length, Marks, Spaces);
    end plstyl;
    ...
    begin
        PKG_PLPLOT_THIN.plstyl(0, Dummy_Marks, Dummy_Spaces);
    end plstyl;
    ...
    procedure plsurf3d
       (x, y           : Real_Vector; -- surface definition points
        ...
        Contour_Levels : Real_Vector) is -- levels at which to draw contours
    begin
        PKG_PLPLOT_THIN.plsurf3d(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options, Contour_Levels, Contour_Levels'Length);
    end plsurf3d;
    ...
    --     Contour_Levels : Real_Vector) is -- levels at which to draw contours
    -- begin
    --     PKG_PLPLOT_THIN.plfsurf3d(x, y, z_Ops, Matrix_To_Pointers(z), x'Length, y'Length, Options,
    --     Contour_Levels, Contour_Levels'Length);
    -- end plfsurf3d;
    ...
    begin
        PKG_PLPLOT_THIN.plsurf3dl(x, y, Matrix_To_Pointers(z), x'Length, y'Length, Options,
    ...
    begin
        PKG_PLPLOT_THIN.plsvpa(Left_Edge, Right_Edge, Bottom_Edge, Top_Edge);
    end plsvpa;
    ...
    begin
        PKG_PLPLOT_THIN.plsxax(Max_Digits, Field_Digits);
    end plsxax;
    ...
    begin
        PKG_PLPLOT_THIN.plsxwin(Window_ID);
    end plsxwin;
    ...
    begin
        PKG_PLPLOT_THIN.plsyax(Max_Digits, Field_Digits);
    end plsyax;
    ...
    begin
        PKG_PLPLOT_THIN.plsym(x'Length, x, y, Hershey_Code);
    end plsym;
    ...
    begin
        PKG_PLPLOT_THIN.plszax(Max_Digits, Field_Digits);
    end plszax;
    ...
    begin
        PKG_PLPLOT_THIN.pltimefmt(To_C(Format));
    end pltimefmt;
    ...
    begin
        PKG_PLPLOT_THIN.plvasp(Aspect_Ratio);
    end plvasp;
    ...
    begin
        PKG_PLPLOT_THIN.plvpas(x_Min, x_Max, y_Min, y_Max, Aspect_Ratio);
    end plvpas;
    ...
    begin
        PKG_PLPLOT_THIN.plvpor(Left_Edge, Right_Edge, Bottom_Edge, Top_Edge);
    end plvpor;
    ...
    begin
        PKG_PLPLOT_THIN.plw3d(X_Box, Y_Box, Z_Box, X_Min, X_Max, Y_Min, Y_Max, Z_Min, Z_Max, Altitude, Azimuth);
    end plw3d;
    ...
    begin
        PKG_PLPLOT_THIN.plwidth(Pen_Width);
    end plwidth;
    ...
    begin
        PKG_PLPLOT_THIN.plwind(Left_Edge, Right_Edge, Bottom_Edge, Top_Edge);
    end plwind;
    ...
    begin
        ...
        PKG_PLPLOT_THIN.plxormod(PL_Use_XOR, PL_Supports_XOR);
...
--  EXCEPT FOR THE FOLLOWING.
    ...
    begin
        PKG_PLPLOT_THIN.plsetopt(To_C(Option, True), To_C(Argument, True));
    end plsetopt;


	-- Transformation routines

    -- fix this These functions are redundant with those in pkg_plplot_thin.
    ...
    -- of pltr? from pkg_plplot_thin.adb into pkg_plplot_traditional.adb and
    -- plplot.adb, then optionally eliminating the bodies from pkg_plplot_thin.adb
    -- on the idea that nobody is going to use them anyway. But even if the
    -- bodies were left in pkg_plplot_thin.adb, having them here would still
    ...
    procedure pltr0
       (x_Grid, y_Grid   : Long_Float;
        ...
        Data             : PL_Pointer) is
    begin
        PKG_PLPLOT_THIN.pltr0(x_Grid, y_Grid, x_World, y_World, Data);
    end pltr0;
    ...
    begin
        PKG_PLPLOT_THIN.pltr1(x_Grid, y_Grid, x_World, y_World, Data_Pointer);
    end pltr1;
    ...
    procedure pltr2
       (x_Grid, y_Grid   : Long_Float;
        ...
        Data_Pointer     : PL_Pointer) is
    begin
        PKG_PLPLOT_THIN.pltr2(x_Grid, y_Grid, x_World, y_World, Data_Pointer);
    end pltr2;
    ...
    begin
        PKG_PLPLOT_THIN.plGetCursor(Graphics_Input);
    end plGetCursor;
